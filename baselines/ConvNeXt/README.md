...
Generated output normally lives under `debug_tools/ConvNeXt/outputs/` or `Results/`.
...
/home/omerv/anaconda3/envs/DeepEnv/bin/python \
  debug_tools/ConvNeXt/train_convnext_ce.py \
  --stage stage1
```
...
/home/omerv/anaconda3/envs/DeepEnv/bin/python \
  debug_tools/ConvNeXt/train_convnext_ce.py \
  --stage stage2 \
  --init-checkpoint debug_tools/ConvNeXt/outputs/convnext_ce/stage1/best.pth
```
...
`debug_tools/ConvNeXt/outputs/convnext_ce/<stage>/`.
...
/home/omerv/anaconda3/envs/DeepEnv/bin/python \
  debug_tools/DINOv2/train_dinov2_ce.py \
  --stage stage2 \
  --init-checkpoint debug_tools/ConvNeXt/outputs/dinov2_ce/stage1/best.pth
```
...
/home/omerv/anaconda3/envs/DeepEnv/bin/python -u \
  ...
  --stage stage2 \
  --preprocessing center-crop \
  --init-checkpoint debug_tools/ConvNeXt/outputs/convnext_ce_center_crop/stage1/best.pth
```
