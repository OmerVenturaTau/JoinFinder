...
Typical two-stage use::
    ...
    python debug_tools/ConvNeXt/train_convnext_ce.py --stage stage1
    python debug_tools/ConvNeXt/train_convnext_ce.py --stage stage2 \
...
DEFAULT_OUTPUT_ROOT = PROJECT_ROOT / "debug_tools/ConvNeXt/outputs"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Defaults to debug_tools/ConvNeXt/outputs/<backbone>_ce for full-page "
