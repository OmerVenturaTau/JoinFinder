...
/home/omerv/anaconda3/envs/DeepEnv/bin/python -u \
  debug_tools/SIFT/train_sift_ce.py \
  --stage stage1
```

Feature extraction is CPU/NAS-bound and is performed only once. Cached vectors
are stored under `debug_tools/SIFT/outputs/sift_ce/<stage>/feature_cache/`.
...
/home/omerv/anaconda3/envs/DeepEnv/bin/python -u \
  debug_tools/SIFT/train_sift_ce.py \
  --stage stage2 \
  --init-checkpoint debug_tools/SIFT/outputs/sift_ce/stage1/best.pth
```
