...
```bash
/home/ventura/miniconda3/envs/NN/bin/python "debug_tools/SIFT/sift_latents.py" \
  --image-dir /path/to/images \
  --recursive \
  --output "debug_tools/SIFT/outputs/sift_latents.npz"
```
...
/home/ventura/miniconda3/envs/NN/bin/python "debug_tools/SIFT/sift_latents.py" \
  ...
  --output "debug_tools/SIFT/outputs/sift_latents.npz" \
  --csv-output "debug_tools/SIFT/outputs/sift_latents.csv"
```
...
```bash
/home/ventura/miniconda3/envs/NN/bin/python "debug_tools/SIFT/compare_clusters_pairs_sift.py"
```

This defaults to:

- input: `results_analysis/test_set/clusters_images_metadata.csv`
- output: `debug_tools/SIFT/outputs/clusters_images_metadata_pairs_sift.xlsx`
...
```bash
/home/ventura/miniconda3/envs/NN/bin/python "debug_tools/SIFT/compare_clusters_pairs_sift.py" \
  --latents-output "debug_tools/SIFT/outputs/sift_latents_test_set.npz"
```

```bash
/home/ventura/miniconda3/envs/NN/bin/python "debug_tools/SIFT/compare_clusters_pairs_sift.py" \
  --load-latents "debug_tools/SIFT/outputs/sift_latents_test_set.npz"
```
...
/home/omerv/anaconda3/envs/DeepEnv/bin/python \
  "debug_tools/compare_clusters_pairs_backbone.py"
```
