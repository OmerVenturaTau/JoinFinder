...
from Debugs.SIFT.train_sift_ce import FEATURE_DIM, SiftCEModel  # noqa: E402
from system import CLUSTER_PAIRS_CSV_PATH  # noqa: E402


DEFAULT_CHECKPOINT = (
    PROJECT_ROOT / "Debugs/SIFT/outputs/sift_ce/stage1/best.pth"
)
...
def parse_args():
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=PROJECT_ROOT / "Debugs/SIFT/outputs/ocr_polygon",
    )
