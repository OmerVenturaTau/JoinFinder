...
TRAINED_CHECKPOINTS = {
    "convnext": PROJECT_ROOT / "Debugs/ConvNeXt/outputs/convnext_ce/stage1/best.pth",
    "dinov2": PROJECT_ROOT / "Debugs/ConvNeXt/outputs/dinov2_ce/stage1/best.pth",
}
