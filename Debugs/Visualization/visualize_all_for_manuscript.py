...
Outputs are saved to:
  Debugs/Visualization/outputs/<manuscript_id>/<image_stem>/
...
Examples:
  python Debugs/Visualization/visualize_all_for_manuscript.py --manuscript 99005239975 --mode geniza --random
  python Debugs/Visualization/visualize_all_for_manuscript.py --image 99005239975/IE168614219_P000002_FL168614222.jpg --mode geniza
  python Debugs/Visualization/visualize_all_for_manuscript.py --image 99005239975/IE168614219_P000002_FL168614222.jpg --mode pretrain --split train
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--out-dir",
        type=str,
        default=str(PROJECT_ROOT / "Debugs" / "Visualization" / "outputs"),
        help="Output root directory (default: Debugs/Visualization/outputs).",
    )
    parser.add_argument(
