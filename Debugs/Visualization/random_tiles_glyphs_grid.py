...
Examples:
  python Debugs/Visualization/random_tiles_glyphs_grid.py --source geniza

  python Debugs/Visualization/random_tiles_glyphs_grid.py \
      --source training \
      --stage stage1 \
      --split train
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--out-dir",
        default=str(PROJECT_ROOT / "Debugs" / "Visualization" / "outputs" / "random_tiles_glyphs_grid"),
    )
