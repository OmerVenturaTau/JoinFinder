...
Usage (examples):
    ...
    python Debugs/impact_analysis/swap_sensitivity.py --checkpoint PATH_TO_PTH
    python Debugs/impact_analysis/swap_sensitivity.py --checkpoint PATH_TO_PTH --source geniza
    python Debugs/impact_analysis/swap_sensitivity.py --checkpoint PATH_TO_PTH --pair-seed 1234
    python Debugs/impact_analysis/swap_sensitivity.py --checkpoint PATH_TO_PTH --split train --index-a 0 --index-b 1
    python Debugs/impact_analysis/swap_sensitivity.py --checkpoint PATH_TO_PTH --pair-type on
    python Debugs/impact_analysis/swap_sensitivity.py --checkpoint PATH_TO_PTH --pair-type oo --num-tests 5
"""
