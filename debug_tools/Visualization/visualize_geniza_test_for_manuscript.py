...
images that have image_path and xml_path in the DB, then invokes:
  ...
  python debug_tools/Visualization/visualize_all_for_manuscript.py --image <manuscript_id>/<picture_id> --mode geniza

Examples:
  python debug_tools/Visualization/visualize_geniza_test_for_manuscript.py --dry-run
  python debug_tools/Visualization/visualize_geniza_test_for_manuscript.py --skip-existing --skip-glyph-tighten-comparison
  python debug_tools/Visualization/visualize_geniza_test_for_manuscript.py --limit-manuscripts 2 --limit-images 5
"""
...
DEFAULT_OUT_DIR = PROJECT_ROOT / "debug_tools" / "Visualization" / "outputs"
VISUALIZE_SCRIPT = PROJECT_ROOT / "debug_tools" / "Visualization" / "visualize_all_for_manuscript.py"
