...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default=None, help="Override output folder (default: debug_tools/impact_analysis/diagnosis/<ms1>-<ms2>)")
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="",
    ...
    if args.find_problematic:
        ...
        if image1_path and image2_path:
            if args.output_dir:
                ...
                output_dir = os.path.join(project_root, "debug_tools", "impact_analysis", "diagnosis", f"{_safe_folder(ms1)}-{_safe_folder(ms2)}")
            compare_two_images(
                image1_path,
                image2_path,
                xml1_path,
            ...
            print("  python debug_tools/impact_analysis/diagnose_similarity_issue.py --image1 9900.../IE....jpg --image2 9900.../IE....jpg")
            print("  # Or by manuscript_id + picture_id:")
            print("  python debug_tools/impact_analysis/diagnose_similarity_issue.py --ms1 9900... --pic1 IE....jpg --ms2 9900... --pic2 IE....jpg")
            print("  # With a checkpoint for on-the-fly similarity:")
            print("  python debug_tools/impact_analysis/diagnose_similarity_issue.py --ms1 9900... --pic1 IE....jpg --ms2 9900... --pic2 IE....jpg --checkpoint path/to/model.pth")
            print("  # With relaxed ALTO filters:")
            print("  python debug_tools/impact_analysis/diagnose_similarity_issue.py --ms1 9900... --pic1 IE....jpg --ms2 9900... --pic2 IE....jpg --checkpoint path/to/model.pth --relaxed-alto-filters")
            print("  # Or to search for problematic pairs:")
            print("  python debug_tools/impact_analysis/diagnose_similarity_issue.py --find-problematic")
