...
### `debug_tools/LetterAppearance/analyze_geniza_letters.py`
...
`debug_tools/LetterAppearance/README.md` for usage and output details.
...
### `debug_tools/ConvNeXt/convnext_blur_sensitivity.py`
...
Output:
- default folder: `debug_tools/ConvNeXt/outputs/convnext_blur_sensitivity/`
- main files:
  - `summary.md`
  - `measurements.csv`
  - `aggregate_plots/*.png`
...
### `debug_tools/ConvNeXt/convnext_latent_restoration.py`
...
Output:
- default folder: `debug_tools/ConvNeXt/outputs/convnext_latent_restoration/`
- main files:
  - `summary.md`
  - `summary.csv`
  - `tile_convnext/.../*.png`
...
### `debug_tools/ConvNeXt/convnext_tile_glyph_histograms.py`
...
```bash
python debug_tools/ConvNeXt/convnext_tile_glyph_histograms.py \
  --split val \
  --n-same 200 \
  --n-cross 500
```
...
Output:
- default folder: `debug_tools/ConvNeXt/outputs/convnext_tile_glyph_histograms/`
- main files:
...
### `debug_tools/DINOv2/dinov2_tile_glyph_histograms.py`
...
```bash
python debug_tools/DINOv2/dinov2_tile_glyph_histograms.py \
  --split val \
  --n-same 200 \
  --n-cross 500
```
...
Output:
- default folder: `debug_tools/DINOv2/outputs/dinov2_tile_glyph_histograms/`
- main files:
...
### `debug_tools/Augmentations/branch_augmentation_label_flips.py`
...
Output:
- default folder: `debug_tools/Augmentations/outputs/branch_augmentation_label_flips/`
- main files:
...
### `debug_tools/Augmentations/sample_geniza_fragment_and_visualize_augmentations.py`
...
```bash
python debug_tools/Augmentations/sample_geniza_fragment_and_visualize_augmentations.py --random
```

Output:
- default folder: `debug_tools/Augmentations/outputs/sample_geniza_fragment_and_visualize_augmentations/`
- main files:
  - `tile_aug_grid.png`
  - `glyph_aug_grid.png`
...
### `debug_tools/BackgroundLeakage/inspect_geniza_tiles_by_library_background.py`
...
Output:
- default folder: `debug_tools/BackgroundLeakage/outputs/geniza_tile_background_inspection/`
- main files:
  - `tile_background_metrics.csv`
  - `grids/<library>/*.png`

### `debug_tools/BackgroundLeakage/inspect_geniza_glyphs_by_library_background.py`
...
```bash
python debug_tools/BackgroundLeakage/inspect_geniza_glyphs_by_library_background.py \
  --limit 40 \
  --max-glyphs 24 \
  --only-middle-glyphs
```
...
Output:
- default folder: `debug_tools/BackgroundLeakage/outputs/geniza_glyph_background_inspection/`
- main files:
...
### `debug_tools/impact_analysis/discriminability_calibration.py`
...
```bash
python debug_tools/impact_analysis/discriminability_calibration.py \
  --checkpoint Results/best_model/your_checkpoint.pth \
  --split val
```

Output:
- default folder: `debug_tools/impact_analysis/outputs/discriminability_calibration/`
- main files:
  - CSV summaries
...
### `debug_tools/impact_analysis/swap_sensitivity.py`
...
```bash
python debug_tools/impact_analysis/swap_sensitivity.py \
  --checkpoint Results/best_model/your_checkpoint.pth \
  --pair-type on \
  --num-tests 5
```
...
Output:
- default folder: `debug_tools/impact_analysis/outputs/swap_sensitivity/`
- main files:
